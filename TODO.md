...
- [ ] F-25 — Create `.github/workflows/wp-placeholder-lint.yml` — fail any merge to `main` containing `<TO-BE-ASSIGNED-AT-ANCHOR>` or other placeholder strings inside `WHITEPAPER/` artifacts (per wp-v0.2 §1.6 documentation hygiene)
